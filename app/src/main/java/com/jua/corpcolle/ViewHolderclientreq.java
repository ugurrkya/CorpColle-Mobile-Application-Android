...
public class ViewHolderclientreq extends RecyclerView.ViewHolder {
    View mView;

    public ViewHolderclientreq(@NonNull View itemView) {
        super(itemView);
    ...
    private ViewHolderclientreq.ClickListener mClickListener;
    ...
    public void setOnClickListener(ViewHolderclientreq.ClickListener clickListener){
