...
public class ClientLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userEmailEditText = (EditText)findViewById(R.id.clientemail);
        userPasswordEditText = (EditText)findViewById(R.id.clientpassword);
        userPasswordEditText.setTransformationMethod(new PasswordTransformationMethod());
        loginLayoutBtn = (Button) findViewById(R.id.client_login);
        createAccountLayoutBtn =(Button) findViewById(R.id.client_register);
        ...
        get_password.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ClientLoginActivity.this, GetPasswordActivity.class));
            }
        });
                    ...
                    userDF.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if(dataSnapshot.exists()){
                                Intent moveToHome = new Intent(ClientLoginActivity.this, ClientMainActivity.class);
    ...
    private void loginUser() {
        ...
        if (!TextUtils.isEmpty(userEmail) && !TextUtils.isEmpty(userPassword))
        {
            ...
            mAuth.signInWithEmailAndPassword(userEmail,userPassword).addOnCompleteListener(this,new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    {
                        Toast.makeText(ClientLoginActivity.this, "Unable to logging user", Toast.LENGTH_LONG).show();
                        mProgressDialog.dismiss();
                    }
                }
            });
        ...
        {
            Toast.makeText(ClientLoginActivity.this, "Please enter user email and password", Toast.LENGTH_LONG).show();
            mProgressDialog.dismiss();
        }
