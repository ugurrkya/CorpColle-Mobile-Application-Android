...
public class MySalesFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = getView().findViewById(R.id.recyclerViewmysales);
        ...
        FirebaseRecyclerAdapter<MySalesData, ViewHolderSales> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<MySalesData, ViewHolderSales>(
                        MySalesData.class,
                        R.layout.rowmysales,
                        ViewHolderSales.class,
                        Sorts
                ){
                    @Override
                    protected void populateViewHolder(ViewHolderSales viewHolder, MySalesData mySalesData, int position) {
                    ...
                    @Override
                    public ViewHolderSales onCreateViewHolder(ViewGroup parent, int viewType) {

                        ViewHolderSales viewHolder = super.onCreateViewHolder(parent, viewType);


                        viewHolder.setOnClickListener(new ViewHolderSales.ClickListener() {
                            @Override
