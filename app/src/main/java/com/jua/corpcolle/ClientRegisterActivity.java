        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null)
                {
                    ...
                    Intent moveToHome = new Intent(ClientRegisterActivity.this,  UserProfileActivity.class);
            ...
            mAuth.createUserWithEmailAndPassword(emailUser, passUser).addOnCompleteListener(this,new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    if(task.isSuccessful() )
                    {
                        ...
                        Toast.makeText(ClientRegisterActivity.this, "Account created success",Toast.LENGTH_LONG).show();
                    ...
                    {
                        Toast.makeText(ClientRegisterActivity.this, "Account creation failed",Toast.LENGTH_LONG).show();
                        mProgressDialog.dismiss();
                    }
                }
            });
        }else{
            Toast.makeText(ClientRegisterActivity.this, "Please fill the areas", Toast.LENGTH_SHORT).show();
        }
